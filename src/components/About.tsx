...
const experience = [
  ...
  {
    period: "С 2025 года",
    title: "Клиника «Санитас» (Новосибирск) — врач-кардиолог и аритмолог",
  },
  {
    period: "Также",
    title: "Прием в Центре новых медицинских технологий (ЦНМТ)",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-lg text-slate-600 mb-8">
                ...
                <p>
                  Ведет прием в Новосибирске в клинике «Санитас» и Центре новых медицинских
                  технологий (ЦНМТ). Проводит комплексную оценку состояния, анализирует
                  медицинские документы и выстраивает индивидуальный план лечения и
                  профилактики.
                </p>
