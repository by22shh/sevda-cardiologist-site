...
const faqs = [
  ...
  },
  {
    ...
    answer: "Нет, прием платный и проводится по прейскуранту клиники.",
  },
  {
    question: "Где проходит прием?",
    answer: "Клиника «Санитас» (ул. Восход, 28) и ЦНМТ (ул. Пирогова, 25/4) в Новосибирске.",
  },
  {
    question: "Можно ли пройти программирование ЭКС или ИКД?",
    answer: "Да, проводится контроль и программирование уже установленных устройств.",
  },
  {
    question: "Как записаться на прием?",
    answer: "Через контакт-центр клиники по телефону или оставив заявку на сайте.",
  },
];
