    ...
    <div className="fixed bottom-24 right-8 z-50">
      ...
      >
        <a
          ...
          className="flex items-center gap-3 bg-[#0088cc] hover:bg-[#006699] text-white px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-3 bg-[#25D366] hover:bg-[#1ea952] text-white px-4 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
        >
          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
        ...
        >
          ...
          <span className="font-medium whitespace-nowrap">Позвонить</span>
        </a>
      </div>
      ...
      >
        {isOpen ? <X className="w-7 h-7" /> : <PhoneCall className="w-7 h-7" />}
      </button>
    </div>
  );
}
